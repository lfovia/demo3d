...
for i = 2:10
    path1 = [pwd,'/plots/lowpass/','video_',num2str(i)];
    mkdir(path1);
    for j = 1:14
        ...
        m_mag = conv2(m_mag_1,filter,'same');
...
%         saveas(gcf,['histogram_u_vid',num2str(i,'%02i'),'frame',num2str(frame_list(i,j),'%03i'),'.png'])
...
%         saveas(gcf,['Joint_prob_u_depth_vid',num2str(i,'%02i'),'frame',num2str(frame_list(i,j),'%03i'),'.fig'])
...
%         saveas(gcf,['Multi_prob_u_depth_vid',num2str(i,'%02i'),'frame',num2str(frame_list(i,j),'%03i'),'.fig'])
...
%         saveas(gcf,['Joint_contour_u_depth_vid',num2str(i,'%02i'),'frame',num2str(frame_list(i,j),'%03i'),'.fig'])
...
%         saveas(gcf,['Multi_contour_u_depth_vid',num2str(i,'%02i'),'frame',num2str(frame_list(i,j),'%03i'),'.fig'])
