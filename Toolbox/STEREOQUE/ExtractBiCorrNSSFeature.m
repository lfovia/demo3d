...
param.scl_idx = 1:1; % scale index
param.scl_num = length ( param.scl_idx );
param.ort_idx = 1:1; % orientation index
...
for scl = 1:param.scl_num
    ...
    for ort = 1:param.ort_num
        ...
        [ bggd_M , bggd_alpha , bggd_beta , bggd_fitted ] = FitMGGD ( [ coeff_temp_1(:)' ; coeff_temp_2(:)' ] , bin_image{1}, bin_image{2} );
        % ----------
